    ...
    <div className="motion-card rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
      ...
      <div className="mt-5 flex gap-3">
        <Link
          ...
          className="motion-press flex-1 rounded-xl border border-gray-200 px-4 py-3 text-center text-sm font-medium text-gray-700 hover:bg-gray-50"
        >
          View Profile
        </Link>
        ...
        <button
          ...
          className={`motion-press flex-1 rounded-xl px-4 py-3 text-sm font-medium text-white ${
            isAvailable
